...
For guidance on authoring CQL against FHIR generally, and US Core and US Quality Core specifically &mdash; element considerations, accessing data, use of terminologies, and similar considerations &mdash; see the [FHIR Patterns](pattern_fhir.html) topic in this guide.
